...
namespace Invector.CharacterController
{
    public class vThirdPersonInput : MonoBehaviour
    {
      ...
      //      UpdateCameraStates();               // update camera states
        ...
        {   
			cc.input.x = 0;//Input.GetAxis(horizontalInput);
			cc.input.y = 1;//Input.GetAxis(verticallInput);
        }
        ...
        {
			if (Input.GetKeyDown(sprintInput) || UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetButtonDown("Run"))
                cc.Sprint(true);
			else if(Input.GetKeyUp(sprintInput)  || UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetButtonUp("Run"))
                cc.Sprint(false);
        }

        protected virtual void JumpInput()
        {
			if (Input.GetKeyDown(jumpInput) || UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetButtonDown("Jump"))
                cc.Jump();
        }
